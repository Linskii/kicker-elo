      ...
      <div className="bg-gray-800 rounded-lg p-8 shadow-xl">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full py-2 px-4 bg-white hover:bg-gray-100 disabled:bg-gray-200 text-gray-900 font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
          >
